...
Small python command line tool that generates comparative plots for multiple rnaQUAST short reports.<br>
...
I found the metric "Avg. mismatches per transcripts" to favor assemblies with transcript that are shorter<br>
...
In the combined plot all values are scaled to [0,1], the details of the scaling operations can be found below.<br>
